...
VALUES ('20220630234341_V_1_7_9', '7.0.9');
...
ALTER TABLE "BusinessProfileRecord" ADD "IsFavorite" boolean NOT NULL DEFAULT FALSE;

ALTER TABLE "AspNetUsers" ADD "CommunicationsEmail" text NULL;

ALTER TABLE "AspNetUsers" ADD "CultureIdentifier" text NULL;

ALTER TABLE "AspNetUsers" ADD "CurrencyFormat" text NULL;

ALTER TABLE "AspNetUsers" ADD "EnableCommunications" boolean NOT NULL DEFAULT FALSE;

ALTER TABLE "AspNetUsers" ADD "EnableHighContrast" boolean NOT NULL DEFAULT FALSE;

ALTER TABLE "AspNetUsers" ADD "LastActivity" timestamp with time zone NOT NULL DEFAULT TIMESTAMPTZ '-infinity';

ALTER TABLE "AspNetUsers" ADD "MenuBehavior" integer NOT NULL DEFAULT 0;

ALTER TABLE "AspNetUsers" ADD "StartupDirectory" integer NOT NULL DEFAULT 0;

ALTER TABLE "AspNetUsers" ADD "ThemeMode" integer NOT NULL DEFAULT 0;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220709201836_V_1_8_3', '7.0.9');
...
ALTER TABLE "BusinessSecurityLog" DROP CONSTRAINT "FK_BusinessSecurityLog_BusinessProfileRecord_BusinessProfileRe~";
...
ALTER TABLE "Project" ADD "AccountHolderID" text NULL;

ALTER TABLE "Project" ADD "ContactID" text NULL;

ALTER TABLE "Invoice" ADD "EntitlementID" text NULL;

ALTER TABLE "Entitlement" ADD "EnableProRateBilling" boolean NOT NULL DEFAULT FALSE;

ALTER TABLE "Entitlement" ADD "EnableUsageThreshold" boolean NOT NULL DEFAULT FALSE;

ALTER TABLE "Entitlement" ADD "NextInvoiceDateTime" timestamp with time zone NOT NULL DEFAULT TIMESTAMPTZ '-infinity';

ALTER TABLE "Entitlement" ADD "UsageThreshold" integer NOT NULL DEFAULT 0;

ALTER TABLE "Log" ADD "AccountHolderID" text NULL;

ALTER TABLE "Log" ADD "ContactID" text NULL;

ALTER TABLE "Log" ADD "CountryLanguageID" text NULL;

ALTER TABLE "Log" ADD "Data" text NULL;

ALTER TABLE "Log" ADD "Data1" text NULL;

ALTER TABLE "Log" ADD "Data1Label" text NULL;

ALTER TABLE "Log" ADD "Data2" text NULL;

ALTER TABLE "Log" ADD "Data2Label" text NULL;

ALTER TABLE "Log" ADD "Data3" text NULL;

ALTER TABLE "Log" ADD "Data3Label" text NULL;

ALTER TABLE "Log" ADD "Data4" text NULL;

ALTER TABLE "Log" ADD "Data4Label" text NULL;

ALTER TABLE "Log" ADD "Data5" text NULL;

ALTER TABLE "Log" ADD "Data5Label" text NULL;

ALTER TABLE "Log" ADD "Data6" text NULL;

ALTER TABLE "Log" ADD "Data6Label" text NULL;

ALTER TABLE "Log" ADD "Data7" text NULL;

ALTER TABLE "Log" ADD "Data7Label" text NULL;

ALTER TABLE "Log" ADD "Data8" text NULL;

ALTER TABLE "Log" ADD "Data8Label" text NULL;

ALTER TABLE "Log" ADD "Data9" text NULL;

ALTER TABLE "Log" ADD "Data9Label" text NULL;

ALTER TABLE "Log" ADD "DataLabel" text NULL;

ALTER TABLE "Log" ADD "EntitlementID" text NULL;

ALTER TABLE "Log" ADD "FileUploadID" text NULL;

ALTER TABLE "Log" ADD "LogType" integer NOT NULL DEFAULT 0;

ALTER TABLE "Log" ADD "RequiresAttention" boolean NULL;
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220711120303_V_1_8_4', '7.0.9');
...
ALTER TABLE "JobOfferApplication" ADD "PartnerProfileID" text NULL;
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220718072951_V_1_9_0', '7.0.9');

COMMIT;

START TRANSACTION;

UPDATE "BusinessProfileInvitation" SET "Email" = '' WHERE "Email" IS NULL;
ALTER TABLE "BusinessProfileInvitation" ALTER COLUMN "Email" SET NOT NULL;
ALTER TABLE "BusinessProfileInvitation" ALTER COLUMN "Email" SET DEFAULT '';

ALTER TABLE "BusinessProfileInvitation" ADD "AccountHolderID" text NULL;

ALTER TABLE "BusinessProfileInvitation" ADD "RelatedBusinessProfileRecordID" text NULL;

ALTER TABLE "BusinessProfileInvitation" ADD "Revoked" boolean NOT NULL DEFAULT FALSE;

ALTER TABLE "BusinessProfileInvitation" ADD "RevokedTimestamp" timestamp with time zone NOT NULL DEFAULT TIMESTAMPTZ '-infinity';

ALTER TABLE "BusinessProfileInvitation" ADD "Timestamp" timestamp with time zone NOT NULL DEFAULT TIMESTAMPTZ '-infinity';
...
ALTER TABLE "BusinessProfileInvitation" ADD CONSTRAINT "FK_BusinessProfileInvitation_BusinessProfileRecord_RelatedBusi~" FOREIGN KEY ("RelatedBusinessProfileRecordID") REFERENCES "BusinessProfileRecord" ("ID");

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220719215658_V_1_9_1', '7.0.9');

COMMIT;

START TRANSACTION;

ALTER TABLE "Log" ADD "SocialProfileID" text NULL;

ALTER TABLE "ActivityRecord" ADD "SocialProfileID" text NULL;
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220725225055_V_1_9_7', '7.0.9');
...
ALTER TABLE "BusinessApplicationSecret" DROP CONSTRAINT "FK_BusinessApplicationSecret_AccessKeyPair_JwtSigningAccessKey~";

ALTER TABLE "LicenseFeature" DROP CONSTRAINT "FK_LicenseFeature_AccessKeyPair_AccessKeyPairID";

DROP INDEX "IX_LicenseFeature_AccessKeyPairID";

ALTER TABLE "AccessKeyPair" DROP CONSTRAINT "PK_AccessKeyPair";

ALTER TABLE "AccessKeyPair" RENAME TO "SecurityCertificate";

ALTER TABLE "LicenseFeature" RENAME COLUMN "AccessKeyPairID" TO "Value";

ALTER TABLE "Item" RENAME COLUMN "MaxLicenseUtilizations" TO "TrialSubscriptionRelativeExpirationInDays";

ALTER TABLE "Entitlement" RENAME COLUMN "PassPhrase" TO "SecurityCertificateID";

ALTER TABLE "Entitlement" RENAME COLUMN "Class" TO "SubscriptionClass";

ALTER TABLE "SecurityCertificate" RENAME COLUMN "IP" TO "Type";

ALTER INDEX "IX_AccessKeyPair_ContactID" RENAME TO "IX_SecurityCertificate_ContactID";

ALTER INDEX "IX_AccessKeyPair_BusinessProfileRecordID" RENAME TO "IX_SecurityCertificate_BusinessProfileRecordID";

ALTER INDEX "IX_AccessKeyPair_BusinessID" RENAME TO "IX_SecurityCertificate_BusinessID";

ALTER INDEX "IX_AccessKeyPair_AccountHolderID" RENAME TO "IX_SecurityCertificate_AccountHolderID";

ALTER TABLE "LicenseFeature" ADD "Key" text NULL;

ALTER TABLE "Item" ADD "AllowSubscriptionTrials" boolean NULL;

ALTER TABLE "Item" ADD "IsPerpetualSubscription" boolean NULL;

ALTER TABLE "Item" ADD "LicensingCertificateID" text NULL;

ALTER TABLE "Item" ADD "MaxLicenseUsages" integer NULL;

ALTER TABLE "Item" ADD "StandardSubscriptionRelativeExpirationInDays" integer NULL;

ALTER TABLE "Item" ADD "SubscriptionsCertificateID" text NULL;

ALTER TABLE "Entitlement" ADD "LicenseClass" integer NULL;

ALTER TABLE "SecurityCertificate" ADD "ID" text NOT NULL DEFAULT '';

ALTER TABLE "SecurityCertificate" ADD "ExpirePeriod" integer NOT NULL DEFAULT 0;

ALTER TABLE "SecurityCertificate" ADD "Expired" boolean NOT NULL DEFAULT FALSE;

ALTER TABLE "SecurityCertificate" ADD "PassPhrase" text NULL;
...
CREATE TABLE "SubscriptionFeature" (
    ...
    CONSTRAINT "FK_SubscriptionFeature_BusinessProfileRecord_BusinessProfileRe~" FOREIGN KEY ("BusinessProfileRecordID") REFERENCES "BusinessProfileRecord" ("ID"),
...
ALTER TABLE "BusinessApplicationSecret" ADD CONSTRAINT "FK_BusinessApplicationSecret_SecurityCertificate_AccessKeyPair~" FOREIGN KEY ("AccessKeyPairID") REFERENCES "SecurityCertificate" ("ID");

ALTER TABLE "BusinessApplicationSecret" ADD CONSTRAINT "FK_BusinessApplicationSecret_SecurityCertificate_JwtSigningAcc~" FOREIGN KEY ("JwtSigningAccessKeyPairID") REFERENCES "SecurityCertificate" ("ID");
...
ALTER TABLE "SecurityCertificate" ADD CONSTRAINT "FK_SecurityCertificate_BusinessProfileRecord_BusinessProfileRe~" FOREIGN KEY ("BusinessProfileRecordID") REFERENCES "BusinessProfileRecord" ("ID");
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220726083059_V_1_9_8', '7.0.9');

COMMIT;

START TRANSACTION;

ALTER TABLE "SecurityCertificate" ADD "EncryptedPrivateKey" boolean NOT NULL DEFAULT FALSE;

ALTER TABLE "SecurityCertificate" ADD "PrivateRsaParameters" text NULL;

ALTER TABLE "SecurityCertificate" ADD "PublicRsaParameters" text NULL;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220726115605_V_1_9_9', '7.0.9');

COMMIT;

START TRANSACTION;

ALTER TABLE "Timezone" ADD "Type" integer NOT NULL DEFAULT 0;

ALTER TABLE "RegionalBlock" ADD "Type" integer NOT NULL DEFAULT 0;

ALTER TABLE "ForeignExchangeSet" ADD "Type" integer NOT NULL DEFAULT 0;

ALTER TABLE "Currency" ADD "Type" integer NOT NULL DEFAULT 0;

ALTER TABLE "CountryState" ADD "Type" integer NOT NULL DEFAULT 0;

ALTER TABLE "CountryRegionalBlockRecord" ADD "Type" integer NOT NULL DEFAULT 0;

ALTER TABLE "CountryLanguageRecord" ADD "Type" integer NOT NULL DEFAULT 0;

ALTER TABLE "CountryLanguage" ADD "Type" integer NOT NULL DEFAULT 0;

ALTER TABLE "CountryCallingCode" ADD "Type" integer NOT NULL DEFAULT 0;

ALTER TABLE "CountryBorder" ADD "Type" integer NOT NULL DEFAULT 0;

ALTER TABLE "CountryAltSpelling" ADD "Type" integer NOT NULL DEFAULT 0;

ALTER TABLE "Country" ADD "Type" integer NOT NULL DEFAULT 0;

ALTER TABLE "City" ADD "Type" integer NOT NULL DEFAULT 0;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220805162232_V_1_9_9_4', '7.0.9');

COMMIT;

START TRANSACTION;

ALTER TABLE "CountryLanguage" ADD "Enabled" boolean NOT NULL DEFAULT FALSE;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20221025201249_V_1_9_9_28', '7.0.9');
...
ALTER INDEX "IX_PaymentDispute_EmmisorWalletAccountID" RENAME TO "IX_PaymentDispute_EmisorWalletAccountID";

ALTER TABLE "Payment" RENAME COLUMN "EmmisorWalletAccountID" TO "EmisorWalletAccountID";

ALTER INDEX "IX_Payment_EmmisorWalletAccountID" RENAME TO "IX_Payment_EmisorWalletAccountID";
...
ALTER INDEX "IX_Invoice_EmmisorWalletAccountID" RENAME TO "IX_Invoice_EmisorWalletAccountID";

ALTER INDEX "IX_Invoice_EmmisorBillingProfileID" RENAME TO "IX_Invoice_EmisorBillingProfileID";
...
ALTER INDEX "IX_Commission_EmmisorWalletAccountID" RENAME TO "IX_Commission_EmisorWalletAccountID";

ALTER INDEX "IX_Commission_EmmisorContactID" RENAME TO "IX_Commission_EmisorContactID";
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20230623233252_V_1_9_9_50', '7.0.9');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20230806223656_V_1_9_9_57', '7.0.9');
