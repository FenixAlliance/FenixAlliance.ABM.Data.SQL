...
('Appointment', NULL, NULL, 'Appointment'),
('Email', NULL, NULL, 'Email'),
('Letter', NULL, NULL, 'Letter'),
('Note', NULL, NULL, 'Note'),
('PhoneCall', NULL, NULL, 'Phone Call'),
('Task', NULL, NULL, 'Task');
...
('accounts_delete', NULL, NULL, 'Accounts', NULL, TRUE, 'Delete accounts'),
('accounts_manage', NULL, NULL, 'Accounts', NULL, TRUE, 'Manage accounts'),
('accounts_read', NULL, NULL, 'Accounts', NULL, TRUE, 'Read accounts'),
('accounts_update', NULL, NULL, 'Accounts', NULL, TRUE, 'Update accounts'),
('assets_create', NULL, NULL, 'Assets', NULL, TRUE, 'Create assets'),
('assets_delete', NULL, NULL, 'Assets', NULL, TRUE, 'Delete assets'),
('assets_manage', NULL, NULL, 'Assets', NULL, TRUE, 'Manage assets'),
('assets_read', NULL, NULL, 'Assets', NULL, TRUE, 'Read assets'),
('assets_update', NULL, NULL, 'Assets', NULL, TRUE, 'Update assets'),
('bots_create', NULL, NULL, 'Bots', NULL, TRUE, 'Create bots'),
('bots_delete', NULL, NULL, 'Bots', NULL, TRUE, 'Delete bots'),
('bots_manage', NULL, NULL, 'Bots', NULL, TRUE, 'Manage bots'),
('bots_read', NULL, NULL, 'Bots', NULL, TRUE, 'Read bots'),
('bots_update', NULL, NULL, 'Bots', NULL, TRUE, 'Update bots'),
('budgets_create', NULL, NULL, 'Budgets', NULL, TRUE, 'Create budgets'),
('budgets_delete', NULL, NULL, 'Budgets', NULL, TRUE, 'Delete budgets'),
('budgets_manage', NULL, NULL, 'Budgets', NULL, TRUE, 'Manage budgets'),
('budgets_read', NULL, NULL, 'Budgets', NULL, TRUE, 'Read budgets'),
('budgets_update', NULL, NULL, 'Budgets', NULL, TRUE, 'Update budgets'),
('campaigns_create', NULL, NULL, 'Campaigns', NULL, TRUE, 'Create campaigns'),
('campaigns_delete', NULL, NULL, 'Campaigns', NULL, TRUE, 'Delete campaigns'),
('campaigns_manage', NULL, NULL, 'Campaigns', NULL, TRUE, 'Manage campaigns'),
('campaigns_read', NULL, NULL, 'Campaigns', NULL, TRUE, 'Read campaigns'),
('campaigns_update', NULL, NULL, 'Campaigns', NULL, TRUE, 'Update campaigns'),
('contacts_create', NULL, NULL, 'Contacts', NULL, TRUE, 'Create contacts'),
('contacts_delete', NULL, NULL, 'Contacts', NULL, TRUE, 'Delete contacts'),
('contacts_manage', NULL, NULL, 'Contacts', NULL, TRUE, 'Manage contacts'),
('contacts_read', NULL, NULL, 'Contacts', NULL, TRUE, 'Read contacts'),
('contacts_update', NULL, NULL, 'Contacts', NULL, TRUE, 'Update contacts'),
('courses_create', NULL, NULL, 'Courses', NULL, TRUE, 'Create courses'),
('courses_delete', NULL, NULL, 'Courses', NULL, TRUE, 'Delete courses'),
('courses_manage', NULL, NULL, 'Courses', NULL, TRUE, 'Manage courses'),
('courses_read', NULL, NULL, 'Courses', NULL, TRUE, 'Read courses'),
('courses_update', NULL, NULL, 'Courses', NULL, TRUE, 'Update courses'),
('deal_units_create', NULL, NULL, 'Deal Units', NULL, TRUE, 'Create deal units'),
('deal_units_delete', NULL, NULL, 'Deal Units', NULL, TRUE, 'Delete deal units'),
('deal_units_manage', NULL, NULL, 'Deal Units', NULL, TRUE, 'Manage deal units'),
('deal_units_read', NULL, NULL, 'Deal Units', NULL, TRUE, 'Read deal units'),
('deal_units_update', NULL, NULL, 'Deal Units', NULL, TRUE, 'Update deal units'),
('employees_create', NULL, NULL, 'Employees', NULL, TRUE, 'Create employees'),
('employees_delete', NULL, NULL, 'Employees', NULL, TRUE, 'Delete employees');
INSERT INTO `BusinessPermission` (`ID`, `BusinessID`, `BusinessProfileRecordID`, `Category`, `Description`, `IsSystemPermission`, `Name`)
VALUES ('employees_manage', NULL, NULL, 'Employees', NULL, TRUE, 'Manage employees'),
('employees_read', NULL, NULL, 'Employees', NULL, TRUE, 'Read employees'),
('employees_update', NULL, NULL, 'Employees', NULL, TRUE, 'Update employees'),
('expenses_create', NULL, NULL, 'Expenses', NULL, TRUE, 'Create expenses'),
('expenses_delete', NULL, NULL, 'Expenses', NULL, TRUE, 'Delete expenses'),
('expenses_manage', NULL, NULL, 'Expenses', NULL, TRUE, 'Manage expenses'),
('expenses_read', NULL, NULL, 'Expenses', NULL, TRUE, 'Read expenses'),
('expenses_update', NULL, NULL, 'Expenses', NULL, TRUE, 'Update expenses'),
('file_uploads_create', NULL, NULL, 'File Uploads', NULL, TRUE, 'Create file uploads'),
('file_uploads_delete', NULL, NULL, 'File Uploads', NULL, TRUE, 'Delete file uploads'),
('file_uploads_manage', NULL, NULL, 'File Uploads', NULL, TRUE, 'Manage file uploads'),
('file_uploads_read', NULL, NULL, 'File Uploads', NULL, TRUE, 'Read file uploads'),
('file_uploads_update', NULL, NULL, 'File Uploads', NULL, TRUE, 'Update file uploads'),
('financialbooks_create', NULL, NULL, 'Financial books', NULL, TRUE, 'Create financial books'),
('financialbooks_delete', NULL, NULL, 'Financial books', NULL, TRUE, 'Delete financial books'),
('financialbooks_manage', NULL, NULL, 'Financial books', NULL, TRUE, 'Manage financial books'),
('financialbooks_read', NULL, NULL, 'Financial books', NULL, TRUE, 'Read financial books'),
('financialbooks_update', NULL, NULL, 'Financial books', NULL, TRUE, 'Update financial books'),
('holders_create', NULL, NULL, 'Holders', NULL, TRUE, 'Create holders'),
('holders_delete', NULL, NULL, 'Holders', NULL, TRUE, 'Delete holders'),
('holders_manage', NULL, NULL, 'Holders', NULL, TRUE, 'Manage holders'),
('holders_read', NULL, NULL, 'Holders', NULL, TRUE, 'Read holders'),
('holders_update', NULL, NULL, 'Holders', NULL, TRUE, 'Update holders'),
('invoices_create', NULL, NULL, 'Invoices', NULL, TRUE, 'Create invoices'),
('invoices_delete', NULL, NULL, 'Invoices', NULL, TRUE, 'Delete invoices'),
('invoices_manage', NULL, NULL, 'Invoices', NULL, TRUE, 'Manage invoices'),
('invoices_read', NULL, NULL, 'Invoices', NULL, TRUE, 'Read invoices'),
('invoices_update', NULL, NULL, 'Invoices', NULL, TRUE, 'Update invoices'),
('journals_create', NULL, NULL, 'Journals', NULL, TRUE, 'Create journals'),
('journals_delete', NULL, NULL, 'Journals', NULL, TRUE, 'Delete journals'),
('journals_manage', NULL, NULL, 'Journals', NULL, TRUE, 'Manage journals'),
('journals_read', NULL, NULL, 'Journals', NULL, TRUE, 'Read journals'),
('journals_update', NULL, NULL, 'Journals', NULL, TRUE, 'Update journals'),
('ledgers_create', NULL, NULL, 'Ledgers', NULL, TRUE, 'Create ledgers'),
('ledgers_delete', NULL, NULL, 'Ledgers', NULL, TRUE, 'Delete ledgers'),
('ledgers_manage', NULL, NULL, 'Ledgers', NULL, TRUE, 'Manage ledgers'),
('ledgers_read', NULL, NULL, 'Ledgers', NULL, TRUE, 'Read ledgers'),
('ledgers_update', NULL, NULL, 'Ledgers', NULL, TRUE, 'Update ledgers'),
('organizations_create', NULL, NULL, 'Organizations', NULL, TRUE, 'Create organizations'),
('organizations_delete', NULL, NULL, 'Organizations', NULL, TRUE, 'Delete organizations'),
('organizations_manage', NULL, NULL, 'Organizations', NULL, TRUE, 'Manage organizations'),
('organizations_read', NULL, NULL, 'Organizations', NULL, TRUE, 'Read organizations');
INSERT INTO `BusinessPermission` (`ID`, `BusinessID`, `BusinessProfileRecordID`, `Category`, `Description`, `IsSystemPermission`, `Name`)
VALUES ('organizations_update', NULL, NULL, 'Organizations', NULL, TRUE, 'Update organizations'),
('payments_create', NULL, NULL, 'Payments', NULL, TRUE, 'Create payments'),
('payments_delete', NULL, NULL, 'Payments', NULL, TRUE, 'Delete payments'),
('payments_manage', NULL, NULL, 'Payments', NULL, TRUE, 'Manage payments'),
('payments_read', NULL, NULL, 'Payments', NULL, TRUE, 'Read payments'),
('payments_update', NULL, NULL, 'Payments', NULL, TRUE, 'Update payments'),
('portal_pages_create', NULL, NULL, 'Portal Pages', NULL, TRUE, 'Create pages'),
('portal_pages_delete', NULL, NULL, 'Portal Pages', NULL, TRUE, 'Delete pages'),
('portal_pages_manage', NULL, NULL, 'Portal Pages', NULL, TRUE, 'Manage pages'),
('portal_pages_read', NULL, NULL, 'Portal Pages', NULL, TRUE, 'Read pages'),
('portal_pages_update', NULL, NULL, 'Portal Pages', NULL, TRUE, 'Update pages'),
('portal_posts_create', NULL, NULL, 'Blog Posts', NULL, TRUE, 'Create blog posts'),
('portal_posts_delete', NULL, NULL, 'Blog Posts', NULL, TRUE, 'Delete blog posts'),
('portal_posts_manage', NULL, NULL, 'Blog Posts', NULL, TRUE, 'Manage blog posts'),
('portal_posts_read', NULL, NULL, 'Blog Posts', NULL, TRUE, 'Read blog posts'),
('portal_posts_update', NULL, NULL, 'Blog Posts', NULL, TRUE, 'Update blog posts'),
('portal_settings_create', NULL, NULL, 'Portal Settings', NULL, TRUE, 'Create portal settings'),
('portal_settings_delete', NULL, NULL, 'Portal Settings', NULL, TRUE, 'Delete portal settings'),
('portal_settings_manage', NULL, NULL, 'Portal Settings', NULL, TRUE, 'Manage portal settings'),
('portal_settings_read', NULL, NULL, 'Portal Settings', NULL, TRUE, 'Read portal settings'),
('portal_settings_update', NULL, NULL, 'Portal Settings', NULL, TRUE, 'Update portal settings'),
('portals_create', NULL, NULL, 'Portals', NULL, TRUE, 'Create portals'),
('portals_delete', NULL, NULL, 'Portals', NULL, TRUE, 'Delete portals'),
('portals_manage', NULL, NULL, 'Portals', NULL, TRUE, 'Manage portals'),
('portals_read', NULL, NULL, 'Portals', NULL, TRUE, 'Read portals'),
('portals_update', NULL, NULL, 'Portals', NULL, TRUE, 'Update portals'),
('pricelists_create', NULL, NULL, 'Prices', NULL, TRUE, 'Create price lists'),
('pricelists_delete', NULL, NULL, 'Prices', NULL, TRUE, 'Delete price lists'),
('pricelists_manage', NULL, NULL, 'Prices', NULL, TRUE, 'Manage price lists'),
('pricelists_read', NULL, NULL, 'Prices', NULL, TRUE, 'Read price lists'),
('pricelists_update', NULL, NULL, 'Prices', NULL, TRUE, 'Update price lists'),
('prices_create', NULL, NULL, 'Prices', NULL, TRUE, 'Create prices'),
('prices_delete', NULL, NULL, 'Prices', NULL, TRUE, 'Delete prices'),
('prices_manage', NULL, NULL, 'Prices', NULL, TRUE, 'Manage prices'),
('prices_read', NULL, NULL, 'Prices', NULL, TRUE, 'Read prices'),
('prices_update', NULL, NULL, 'Prices', NULL, TRUE, 'Update prices'),
('product_taxonomies_create', NULL, NULL, 'Product taxonomies', NULL, TRUE, 'Create product taxonomies'),
('product_taxonomies_delete', NULL, NULL, 'Product taxonomies', NULL, TRUE, 'Delete product taxonomies'),
('product_taxonomies_manage', NULL, NULL, 'Product taxonomies', NULL, TRUE, 'Manage product taxonomies'),
('product_taxonomies_read', NULL, NULL, 'Product taxonomies', NULL, TRUE, 'Read product taxonomies'),
('product_taxonomies_update', NULL, NULL, 'Product taxonomies', NULL, TRUE, 'Update product taxonomies'),
('products_create', NULL, NULL, 'Products', NULL, TRUE, 'Create products');
INSERT INTO `BusinessPermission` (`ID`, `BusinessID`, `BusinessProfileRecordID`, `Category`, `Description`, `IsSystemPermission`, `Name`)
VALUES ('products_delete', NULL, NULL, 'Products', NULL, TRUE, 'Delete products'),
('products_manage', NULL, NULL, 'Products', NULL, TRUE, 'Manage products'),
('products_read', NULL, NULL, 'Products', NULL, TRUE, 'Read products'),
('products_update', NULL, NULL, 'Products', NULL, TRUE, 'Update products'),
('projects_create', NULL, NULL, 'Projects', NULL, TRUE, 'Create projects'),
('projects_delete', NULL, NULL, 'Projects', NULL, TRUE, 'Delete projects'),
('projects_manage', NULL, NULL, 'Projects', NULL, TRUE, 'Manage projects'),
('projects_read', NULL, NULL, 'Projects', NULL, TRUE, 'Read projects'),
('projects_update', NULL, NULL, 'Projects', NULL, TRUE, 'Update projects'),
('purchase_requests_create', NULL, NULL, 'Purchase Requests', NULL, TRUE, 'Create purchase requests'),
('purchase_requests_delete', NULL, NULL, 'Purchase Requests', NULL, TRUE, 'Delete purchase requests'),
('purchase_requests_manage', NULL, NULL, 'Purchase Requests', NULL, TRUE, 'Manage purchase requests'),
('purchase_requests_read', NULL, NULL, 'Purchase Requests', NULL, TRUE, 'Read purchase requests'),
('purchase_requests_update', NULL, NULL, 'Purchase Requests', NULL, TRUE, 'Update purchase requests'),
('reports_create', NULL, NULL, 'Reports', NULL, TRUE, 'Create reports'),
('reports_delete', NULL, NULL, 'Reports', NULL, TRUE, 'Delete reports'),
('reports_manage', NULL, NULL, 'Reports', NULL, TRUE, 'Manage reports'),
('reports_read', NULL, NULL, 'Reports', NULL, TRUE, 'Read reports'),
('reports_update', NULL, NULL, 'Reports', NULL, TRUE, 'Update reports'),
('security_permissions_create', NULL, NULL, 'Security permissions', NULL, TRUE, 'Create security permissions'),
('security_permissions_delete', NULL, NULL, 'Security permissions', NULL, TRUE, 'Delete security permissions'),
('security_permissions_manage', NULL, NULL, 'Security permissions', NULL, TRUE, 'Manage security permissions'),
('security_permissions_read', NULL, NULL, 'Security permissions', NULL, TRUE, 'Read security permissions'),
('security_permissions_update', NULL, NULL, 'Security permissions', NULL, TRUE, 'Update security permissions'),
('security_roles_create', NULL, NULL, 'Security Roles', NULL, TRUE, 'Create security roles'),
('security_roles_delete', NULL, NULL, 'Security Roles', NULL, TRUE, 'Delete security roles'),
('security_roles_manage', NULL, NULL, 'Security Roles', NULL, TRUE, 'Manage security roles'),
('security_roles_read', NULL, NULL, 'Security Roles', NULL, TRUE, 'Read security roles'),
('security_roles_update', NULL, NULL, 'Security Roles', NULL, TRUE, 'Update security roles'),
('services_create', NULL, NULL, 'Services', NULL, TRUE, 'Create services'),
('services_delete', NULL, NULL, 'Services', NULL, TRUE, 'Delete services'),
('services_manage', NULL, NULL, 'Services', NULL, TRUE, 'Manage services'),
('services_read', NULL, NULL, 'Services', NULL, TRUE, 'Read services'),
('services_update', NULL, NULL, 'Services', NULL, TRUE, 'Update services'),
('shares_create', NULL, NULL, 'Shares', NULL, TRUE, 'Create shares'),
('shares_delete', NULL, NULL, 'Shares', NULL, TRUE, 'Delete shares'),
('shares_manage', NULL, NULL, 'Shares', NULL, TRUE, 'Manage shares'),
('shares_read', NULL, NULL, 'Shares', NULL, TRUE, 'Read shares'),
('shares_update', NULL, NULL, 'Shares', NULL, TRUE, 'Update shares'),
('shippings_create', NULL, NULL, 'Shippings', NULL, TRUE, 'Create shippings'),
('shippings_delete', NULL, NULL, 'Shippings', NULL, TRUE, 'Delete shippings'),
('shippings_manage', NULL, NULL, 'Shippings', NULL, TRUE, 'Manage shippings');
INSERT INTO `BusinessPermission` (`ID`, `BusinessID`, `BusinessProfileRecordID`, `Category`, `Description`, `IsSystemPermission`, `Name`)
VALUES ('shippings_read', NULL, NULL, 'Shippings', NULL, TRUE, 'Read shippings'),
('shippings_update', NULL, NULL, 'Shippings', NULL, TRUE, 'Update shippings'),
('social_groups_create', NULL, NULL, 'Social Groups', NULL, TRUE, 'Create social groups'),
('social_groups_delete', NULL, NULL, 'Social Groups', NULL, TRUE, 'Delete social groups'),
('social_groups_manage', NULL, NULL, 'Social Groups', NULL, TRUE, 'Manage social groups'),
('social_groups_read', NULL, NULL, 'Social Groups', NULL, TRUE, 'Read social groups'),
('social_groups_update', NULL, NULL, 'Social Groups', NULL, TRUE, 'Update social groups'),
('social_posts_create', NULL, NULL, 'Social Posts', NULL, TRUE, 'Create social posts'),
('social_posts_delete', NULL, NULL, 'Social Posts', NULL, TRUE, 'Delete social posts'),
('social_posts_manage', NULL, NULL, 'Social Posts', NULL, TRUE, 'Manage social posts'),
('social_posts_read', NULL, NULL, 'Social Posts', NULL, TRUE, 'Read social posts'),
('social_posts_update', NULL, NULL, 'Social Posts', NULL, TRUE, 'Update social posts'),
('social_profiles_create', NULL, NULL, 'Social Groups', NULL, TRUE, 'Create social profiles'),
('social_profiles_delete', NULL, NULL, 'Social Groups', NULL, TRUE, 'Delete social profiles'),
('social_profiles_manage', NULL, NULL, 'Social Groups', NULL, TRUE, 'Manage social profiles'),
('social_profiles_read', NULL, NULL, 'Social Groups', NULL, TRUE, 'Read social profiles'),
('social_profiles_update', NULL, NULL, 'Social Groups', NULL, TRUE, 'Update social profiles'),
('stock_items_create', NULL, NULL, 'Stock items', NULL, TRUE, 'Create stock items'),
('stock_items_delete', NULL, NULL, 'Stock items', NULL, TRUE, 'Delete stock items'),
('stock_items_manage', NULL, NULL, 'Stock items', NULL, TRUE, 'Manage stock items'),
('stock_items_read', NULL, NULL, 'Stock items', NULL, TRUE, 'Read stock items'),
('stock_items_update', NULL, NULL, 'Stock items', NULL, TRUE, 'Update stock items'),
('studio_access', NULL, NULL, NULL, NULL, TRUE, 'Studio Access (System)'),
('subscriptions_create', NULL, NULL, 'Subscriptions', NULL, TRUE, 'Create subscriptions'),
('subscriptions_delete', NULL, NULL, 'Subscriptions', NULL, TRUE, 'Delete subscriptions'),
('subscriptions_manage', NULL, NULL, 'Subscriptions', NULL, TRUE, 'Manage subscriptions'),
('subscriptions_read', NULL, NULL, 'Subscriptions', NULL, TRUE, 'Read subscriptions'),
('subscriptions_update', NULL, NULL, 'Subscriptions', NULL, TRUE, 'Update subscriptions'),
('taxes_create', NULL, NULL, 'Taxes', NULL, TRUE, 'Create taxes'),
('taxes_delete', NULL, NULL, 'Taxes', NULL, TRUE, 'Delete taxes'),
('taxes_manage', NULL, NULL, 'Taxes', NULL, TRUE, 'Manage taxes'),
('taxes_read', NULL, NULL, 'Taxes', NULL, TRUE, 'Read taxes'),
('taxes_update', NULL, NULL, 'Taxes', NULL, TRUE, 'Update taxes'),
('tenants_create', NULL, NULL, 'Tenants', NULL, TRUE, 'Create tenants'),
('tenants_delete', NULL, NULL, 'Tenants', NULL, TRUE, 'Delete tenants'),
('tenants_manage', NULL, NULL, 'Tenants', NULL, TRUE, 'Manage tenants'),
('tenants_read', NULL, NULL, 'Tenants', NULL, TRUE, 'Read tenants'),
('tenants_update', NULL, NULL, 'Tenants', NULL, TRUE, 'Update tenants'),
('tickets_create', NULL, NULL, 'Tickets', NULL, TRUE, 'Create tickets'),
('tickets_delete', NULL, NULL, 'Tickets', NULL, TRUE, 'Delete tickets'),
('tickets_manage', NULL, NULL, 'Tickets', NULL, TRUE, 'Manage tickets'),
('tickets_read', NULL, NULL, 'Tickets', NULL, TRUE, 'Read tickets');
INSERT INTO `BusinessPermission` (`ID`, `BusinessID`, `BusinessProfileRecordID`, `Category`, `Description`, `IsSystemPermission`, `Name`)
VALUES ('tickets_update', NULL, NULL, 'Tickets', NULL, TRUE, 'Update tickets'),
('warehouses_create', NULL, NULL, 'Warehouses', NULL, TRUE, 'Create warehouses'),
('warehouses_delete', NULL, NULL, 'Warehouses', NULL, TRUE, 'Delete warehouses'),
('warehouses_manage', NULL, NULL, 'Warehouses', NULL, TRUE, 'Manage warehouses'),
('warehouses_read', NULL, NULL, 'Warehouses', NULL, TRUE, 'Read warehouses'),
('warehouses_update', NULL, NULL, 'Warehouses', NULL, TRUE, 'Update warehouses'),
('workflows_create', NULL, NULL, 'Workflows', NULL, TRUE, 'Create workflows'),
('workflows_delete', NULL, NULL, 'Workflows', NULL, TRUE, 'Delete workflows'),
('workflows_manage', NULL, NULL, 'Workflows', NULL, TRUE, 'Manage workflows'),
('workflows_read', NULL, NULL, 'Workflows', NULL, TRUE, 'Read workflows'),
('workflows_update', NULL, NULL, 'Workflows', NULL, TRUE, 'Update workflows');
...
('global_admin', NULL, NULL, NULL, TRUE, 'Global Admin (System)'),
('portal_author', NULL, NULL, NULL, TRUE, 'Portal Author (System)'),
('portal_blocked', NULL, NULL, NULL, TRUE, 'Portal Blocked (System)'),
('portal_collaborator', NULL, NULL, NULL, TRUE, 'Portal Colaborator (System)'),
('portal_default', NULL, NULL, NULL, TRUE, 'Portal Application (System)'),
('portal_editor', NULL, NULL, NULL, TRUE, 'Portal Editor (System)'),
('portal_keymaster', NULL, NULL, NULL, TRUE, 'Portal Keymaster (System)'),
('portal_moderator', NULL, NULL, NULL, TRUE, 'Portal Moderator (System)'),
('portal_participant', NULL, NULL, NULL, TRUE, 'Portal Participant (System)'),
('portal_spectator', NULL, NULL, NULL, TRUE, 'Portal Spectator (System)'),
('portal_suscriptor', NULL, NULL, NULL, TRUE, 'Portal Suscriptor (System)'),
('store_admin', NULL, NULL, NULL, TRUE, 'Store Admin (System)'),
('store_blocked', NULL, NULL, NULL, TRUE, 'Store Blocked (System)'),
('store_customer', NULL, NULL, NULL, TRUE, 'Store Customer (System)'),
('store_manager', NULL, NULL, NULL, TRUE, 'Store Manager (System)'),
('support_agent', NULL, NULL, NULL, TRUE, 'Support Agent (System)'),
('support_manager', NULL, NULL, NULL, TRUE, 'Support Manager (System)'),
('support_supervisor', NULL, NULL, NULL, TRUE, 'Support Supervisor (System)'),
('support_user', NULL, NULL, NULL, TRUE, 'Support User (System)');

INSERT INTO `SalesLiteratureType` (`ID`, `BusinessID`, `BusinessProfileRecordID`, `Name`)
VALUES ('Bulletins', NULL, NULL, 'Bulletins'),
('CompanyBackground', NULL, NULL, 'Company Background'),
('Manuals', NULL, NULL, 'Manuals'),
('MarketingCollateral', NULL, NULL, 'Marketing Collateral'),
('News', NULL, NULL, 'News'),
('PoliciesAndProcedures', NULL, NULL, 'Policies And Procedures'),
('Presentation', NULL, NULL, 'Presentation'),
('PriceSheets', NULL, NULL, 'Price Sheets'),
('ProductSheet', NULL, NULL, 'Product Sheet'),
('SalesLiterature', NULL, NULL, 'Sales Literature'),
('Spreadsheets', NULL, NULL, 'Spreadsheets');
...
('Mass', NULL, NULL, NULL, 'Mass', TRUE),
('Time', NULL, NULL, NULL, 'Time', TRUE),
('Units', NULL, NULL, NULL, 'Units', TRUE);
...
('Millimeters', 0.0, NULL, NULL, NULL, 'Millimeters', 'Distance'),
('Second', 0.0, NULL, NULL, NULL, 'Second', 'Time'),
('Unit', 1.0, NULL, NULL, NULL, 'Unit', 'Units');

INSERT INTO `Unit` (`ID`, `BaseUnitAmount`, `BaseUnitID`, `BusinessID`, `BusinessProfileRecordID`, `Name`, `UnitGroupID`)
VALUES ('Centimeters', 10.0, 'Millimeters', NULL, NULL, 'Centimeters', 'Distance'),
('Dozen', 12.0, 'Unit', NULL, NULL, 'Dozen', 'Units'),
('Grams', 1000.0, 'Milligrams', NULL, NULL, 'Grams', 'Mass'),
('Half a Dozen', 6.0, 'Unit', NULL, NULL, 'Half a Dozen', 'Units'),
('Hundred', 100.0, 'Unit', NULL, NULL, 'Thousand', 'Units'),
('Minute', 60.0, 'Second', NULL, NULL, 'Minute', 'Time'),
('Pair', 2.0, 'Unit', NULL, NULL, 'Pair', 'Units'),
('Thousand', 1000.0, 'Unit', NULL, NULL, 'Thousand', 'Units');
...
('29 Days Month', 29.0, 'Day', NULL, NULL, '29 Days Month', 'Time'),
('30 Days Month', 30.0, 'Day', NULL, NULL, '30 Days Month', 'Time'),
('31 Days Month', 31.0, 'Day', NULL, NULL, '31 Days Month', 'Time'),
('Leap Year (Gregorian calendar)', 366.0, 'Day', NULL, NULL, 'Leap Year (Gregorian calendar)', 'Time'),
('Leap Year (Islamic calendar)', 355.0, 'Day', NULL, NULL, 'Leap Year (Islamic calendar)', 'Time'),
('Week', 7.0, 'Day', NULL, NULL, 'Week', 'Time'),
('Year (Gregorian calendar)', 365.0, 'Day', NULL, NULL, 'Year (Gregorian calendar)', 'Time'),
('Year (Islamic calendar)', 354.0, 'Day', NULL, NULL, 'Year (Islamic calendar)', 'Time');
...
VALUES ('20220518110254_V_1_5_0', '7.0.9');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220523235837_V_1_5_6', '7.0.9');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220525021839_V_1_5_8', '7.0.9');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220528230243_V_1_6_1', '7.0.9');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220529193646_V_1_6_2', '7.0.9');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220530004006_V_1_6_3', '7.0.9');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220530025827_V_1_6_4', '7.0.9');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220530042459_V_1_6_5', '7.0.9');

COMMIT;

START TRANSACTION;

ALTER TABLE `BusinessSegment` DROP FOREIGN KEY `FK_BusinessSegment_Currency_CurrencyID`;

ALTER TABLE `BusinessSegment` DROP INDEX `IX_BusinessSegment_CurrencyID`;
...
ALTER TABLE `ContactProfile` RENAME COLUMN `SalaryExpectation` TO `MinSalaryExpectation`;
...
ALTER TABLE `Gig` MODIFY COLUMN `Type` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `ExpectedDeliveryDate` datetime(6) NOT NULL DEFAULT '0001-01-01 00:00:00';

ALTER TABLE `Gig` ADD `ViewsCount` int NOT NULL DEFAULT 0;

ALTER TABLE `CurriculumRecord` ADD `Current` tinyint(1) NOT NULL DEFAULT FALSE;

ALTER TABLE `CurriculumRecord` ADD `DateFrom` datetime(6) NOT NULL DEFAULT '0001-01-01 00:00:00';

ALTER TABLE `CurriculumRecord` ADD `DateTo` datetime(6) NOT NULL DEFAULT '0001-01-01 00:00:00';

ALTER TABLE `ContactProfile` ADD `CareerLevel` int NULL;

ALTER TABLE `ContactProfile` ADD `CurrentSalary` decimal(65,30) NULL;

ALTER TABLE `ContactProfile` ADD `MaxSalaryExpectation` decimal(65,30) NULL;

ALTER TABLE `Contact` ADD `BattleNetUsername` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Contact` ADD `Brothers` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Contact` ADD `BrothersCount` int NOT NULL DEFAULT 0;

ALTER TABLE `Contact` ADD `Childrens` longtext CHARACTER SET utf8mb4 NULL;
...
ALTER TABLE `Contact` ADD `CreditScore` double NOT NULL DEFAULT 0.0;

ALTER TABLE `Contact` ADD `DirectEmployeesCount` int NOT NULL DEFAULT 0;

ALTER TABLE `Contact` ADD `DisplayInSocialSearch` tinyint(1) NOT NULL DEFAULT FALSE;

ALTER TABLE `Contact` ADD `FacebookPageURL` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Contact` ADD `GithubUsername` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Contact` ADD `IndirectEmployeesCount` int NOT NULL DEFAULT 0;

ALTER TABLE `Contact` ADD `InstagramURL` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Contact` ADD `InstagramUsername` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Contact` ADD `LastContactDate` datetime(6) NOT NULL DEFAULT '0001-01-01 00:00:00';

ALTER TABLE `Contact` ADD `Overdue` tinyint(1) NOT NULL DEFAULT FALSE;

ALTER TABLE `Contact` ADD `OverdueAmount` double NOT NULL DEFAULT 0.0;

ALTER TABLE `Contact` ADD `OverdueLimit` double NOT NULL DEFAULT 0.0;

ALTER TABLE `Contact` ADD `Parents` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Contact` ADD `RedditURL` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Contact` ADD `Spouse` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Contact` ADD `StackExchangeURL` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Contact` ADD `StackOverflowURL` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Contact` ADD `TelegramPhone` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Contact` ADD `TikTokUsername` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Contact` ADD `TwitchURL` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Contact` ADD `TwitterUsername` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Contact` ADD `WhatsAppPhone` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Contact` ADD `XboxLiveUsername` longtext CHARACTER SET utf8mb4 NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220531071648_V_1_6_5_1', '7.0.9');

COMMIT;

START TRANSACTION;

ALTER TABLE `JobOffer` ADD `Data` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data1` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data1Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data2` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data2Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data3` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data3Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data4` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data4Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data5` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data5Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data6` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data6Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data7` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data7Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data8` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data8Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data9` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Data9Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `DataLabel` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data1` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data1Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data2` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data2Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data3` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data3Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data4` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data4Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data5` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data5Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data6` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data6Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data7` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data7Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data8` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data8Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data9` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Data9Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `DataLabel` longtext CHARACTER SET utf8mb4 NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220612013652_V_1_7_7_2', '7.0.9');

COMMIT;

START TRANSACTION;

ALTER TABLE `Signature` DROP FOREIGN KEY `FK_Signature_SignedDocument_SigningDocumentID`;

ALTER TABLE `SignedDocument` DROP FOREIGN KEY `FK_SignedDocument_SigningCertificate_SignatorCertificateID`;

ALTER TABLE `SignedDocument` RENAME COLUMN `SignatorCertificateID` TO `SigningCertificateID`;

ALTER TABLE `SignedDocument` RENAME INDEX `IX_SignedDocument_SignatorCertificateID` TO `IX_SignedDocument_SigningCertificateID`;

ALTER TABLE `Signature` RENAME COLUMN `SigningDocumentID` TO `SignedDocumentID`;

ALTER TABLE `Signature` RENAME INDEX `IX_Signature_SigningDocumentID` TO `IX_Signature_SignedDocumentID`;

ALTER TABLE `SigningCertificate` ADD `Signature` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobTitle` ADD `CityID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobTitle` ADD `CountryID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobTitle` ADD `CountryStateID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobTitle` ADD `CurrencyID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `ExternalUrl` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `ImageUrl` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Location` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `JobOffer` ADD `Remote` tinyint(1) NOT NULL DEFAULT FALSE;

ALTER TABLE `Gig` ADD `ExternalUrl` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Location` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Gig` ADD `Remote` tinyint(1) NOT NULL DEFAULT FALSE;

ALTER TABLE `GenericRecord` ADD `JobFieldID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `GenericRecord` ADD `JobOfferID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `FileUpload` ADD `MD5Hash` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `FileUpload` ADD `Metadata` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `FileUpload` ADD `SignedDocumentID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `ContactProfile` ADD `About` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `ContactProfile` ADD `AvatarUrl` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `ContactProfile` ADD `ExperienceInYears` int NULL;

ALTER TABLE `BusinessSecurityLog` ADD `SignedDocumentID` varchar(255) CHARACTER SET utf8mb4 NULL;
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220613055556_V_1_7_7_3', '7.0.9');

COMMIT;

START TRANSACTION;

ALTER TABLE `ContactProfile` ADD `Hireable` tinyint(1) NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220620193738_V_1_7_8', '7.0.9');

COMMIT;

START TRANSACTION;

ALTER TABLE `WebContent` ADD `SocialProfileID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `TaxonomyRecord` ADD `BlogPostTagID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `IPLookup` ADD `LastAccess` datetime(6) NOT NULL DEFAULT '0001-01-01 00:00:00';

ALTER TABLE `IPLookup` ADD `LastReset` datetime(6) NOT NULL DEFAULT '0001-01-01 00:00:00';

ALTER TABLE `IPLookup` ADD `RecentAccessCount` bigint NOT NULL DEFAULT 0;

ALTER TABLE `IPLookup` ADD `TotalAccessCount` bigint NOT NULL DEFAULT 0;
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220624140315_V_1_7_9', '7.0.9');
...
ALTER TABLE `BusinessTenantSettings` RENAME COLUMN `ForexRates` TO `Data`;

ALTER TABLE `BusinessTenantSettings` RENAME COLUMN `ExchangeRatesUpdatedTimestamp` TO `Timestamp`;

ALTER TABLE `AccountHolderSettings` RENAME COLUMN `ForexRates` TO `Data`;

ALTER TABLE `AccountHolderSettings` RENAME COLUMN `ExchangeRatesUpdatedTimestamp` TO `Timestamp`;

ALTER TABLE `BusinessProfileRecord` ADD `IsFavorite` tinyint(1) NOT NULL DEFAULT FALSE;

ALTER TABLE `AspNetUsers` ADD `CommunicationsEmail` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `AspNetUsers` ADD `CultureIdentifier` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `AspNetUsers` ADD `CurrencyFormat` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `AspNetUsers` ADD `EnableCommunications` tinyint(1) NOT NULL DEFAULT FALSE;

ALTER TABLE `AspNetUsers` ADD `EnableHighContrast` tinyint(1) NOT NULL DEFAULT FALSE;

ALTER TABLE `AspNetUsers` ADD `LastActivity` datetime(6) NOT NULL DEFAULT '0001-01-01 00:00:00';
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220709201216_V_1_8_3', '7.0.9');
...
ALTER TABLE `BusinessSecurityLog` DROP FOREIGN KEY `FK_BusinessSecurityLog_Business_BusinessID`;

ALTER TABLE `BusinessSecurityLog` DROP FOREIGN KEY `FK_BusinessSecurityLog_BusinessProfileRecord_BusinessProfileRec~`;

ALTER TABLE `BusinessSecurityLog` DROP FOREIGN KEY `FK_BusinessSecurityLog_ContactProfile_SigningProfileID`;

ALTER TABLE `BusinessSecurityLog` DROP FOREIGN KEY `FK_BusinessSecurityLog_SignedDocument_SignedDocumentID`;

ALTER TABLE `BusinessSecurityLog` DROP FOREIGN KEY `FK_BusinessSecurityLog_SigningCertificate_SigningCertificateID`;

CALL POMELO_BEFORE_DROP_PRIMARY_KEY(NULL, 'BusinessSecurityLog');
ALTER TABLE `BusinessSecurityLog` DROP PRIMARY KEY;

ALTER TABLE `BusinessSecurityLog` RENAME `Log`;

ALTER TABLE `Log` RENAME COLUMN `Language` TO `SecurityEvent`;

ALTER TABLE `Log` RENAME INDEX `IX_BusinessSecurityLog_SigningProfileID` TO `IX_Log_SigningProfileID`;

ALTER TABLE `Log` RENAME INDEX `IX_BusinessSecurityLog_SigningCertificateID` TO `IX_Log_SigningCertificateID`;

ALTER TABLE `Log` RENAME INDEX `IX_BusinessSecurityLog_SignedDocumentID` TO `IX_Log_SignedDocumentID`;

ALTER TABLE `Log` RENAME INDEX `IX_BusinessSecurityLog_BusinessProfileRecordID` TO `IX_Log_BusinessProfileRecordID`;

ALTER TABLE `Log` RENAME INDEX `IX_BusinessSecurityLog_BusinessID` TO `IX_Log_BusinessID`;

ALTER TABLE `Project` ADD `AccountHolderID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Project` ADD `ContactID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Invoice` ADD `EntitlementID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Entitlement` ADD `EnableProRateBilling` tinyint(1) NOT NULL DEFAULT FALSE;

ALTER TABLE `Entitlement` ADD `EnableUsageThreshold` tinyint(1) NOT NULL DEFAULT FALSE;

ALTER TABLE `Entitlement` ADD `NextInvoiceDateTime` datetime(6) NOT NULL DEFAULT '0001-01-01 00:00:00';

ALTER TABLE `Entitlement` ADD `UsageThreshold` int NOT NULL DEFAULT 0;

ALTER TABLE `Log` ADD `AccountHolderID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `ContactID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `CountryLanguageID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data1` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data1Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data2` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data2Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data3` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data3Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data4` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data4Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data5` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data5Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data6` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data6Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data7` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data7Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data8` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data8Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data9` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `Data9Label` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `DataLabel` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `EntitlementID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `FileUploadID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Log` ADD `LogType` int NOT NULL DEFAULT 0;

ALTER TABLE `Log` ADD `RequiresAttention` tinyint(1) NULL;

ALTER TABLE `Log` ADD CONSTRAINT `PK_Log` PRIMARY KEY (`ID`);
CALL POMELO_AFTER_ADD_PRIMARY_KEY(NULL, 'Log', 'ID');

CREATE TABLE `MementoRecord` (
    `ID` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
    `Description` longtext CHARACTER SET utf8mb4 NULL,
    `Timestamp` datetime(6) NOT NULL,
    `OldSnapshot` longtext CHARACTER SET utf8mb4 NULL,
    `NewSnapshot` longtext CHARACTER SET utf8mb4 NULL,
    `AccountHolderID` varchar(255) CHARACTER SET utf8mb4 NULL,
    `ContactID` varchar(255) CHARACTER SET utf8mb4 NULL,
    `BusinessID` varchar(255) CHARACTER SET utf8mb4 NULL,
    `BusinessProfileRecordID` varchar(255) CHARACTER SET utf8mb4 NULL,
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220711070156_V_1_8_4', '7.0.9');
...
ALTER TABLE `ContactProfile` RENAME COLUMN `Hireable` TO `AvailableForHire`;

ALTER TABLE `JobOfferApplication` ADD `PartnerProfileID` varchar(255) CHARACTER SET utf8mb4 NULL;
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220718071433_V_1_9_0', '7.0.9');

COMMIT;

START TRANSACTION;

ALTER TABLE `BusinessProfileInvitation` MODIFY COLUMN `RedeemedTimestamp` datetime(6) NOT NULL;

UPDATE `BusinessProfileInvitation` SET `Email` = ''
WHERE `Email` IS NULL;
SELECT ROW_COUNT();


ALTER TABLE `BusinessProfileInvitation` MODIFY COLUMN `Email` longtext CHARACTER SET utf8mb4 NOT NULL;

ALTER TABLE `BusinessProfileInvitation` ADD `AccountHolderID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `BusinessProfileInvitation` ADD `RelatedBusinessProfileRecordID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `BusinessProfileInvitation` ADD `Revoked` tinyint(1) NOT NULL DEFAULT FALSE;

ALTER TABLE `BusinessProfileInvitation` ADD `RevokedTimestamp` datetime(6) NOT NULL DEFAULT '0001-01-01 00:00:00';

ALTER TABLE `BusinessProfileInvitation` ADD `Timestamp` datetime(6) NOT NULL DEFAULT '0001-01-01 00:00:00';
...
ALTER TABLE `BusinessProfileInvitation` ADD CONSTRAINT `FK_BusinessProfileInvitation_BusinessProfileRecord_RelatedBusin~` FOREIGN KEY (`RelatedBusinessProfileRecordID`) REFERENCES `BusinessProfileRecord` (`ID`);

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220719214944_V_1_9_1', '7.0.9');

COMMIT;

START TRANSACTION;

ALTER TABLE `Log` ADD `SocialProfileID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `ActivityRecord` ADD `SocialProfileID` varchar(255) CHARACTER SET utf8mb4 NULL;
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220725223955_V_1_9_7', '7.0.9');
...
ALTER TABLE `AccessKeyPair` DROP FOREIGN KEY `FK_AccessKeyPair_AspNetUsers_AccountHolderID`;

ALTER TABLE `AccessKeyPair` DROP FOREIGN KEY `FK_AccessKeyPair_Business_BusinessID`;

ALTER TABLE `AccessKeyPair` DROP FOREIGN KEY `FK_AccessKeyPair_BusinessProfileRecord_BusinessProfileRecordID`;

ALTER TABLE `AccessKeyPair` DROP FOREIGN KEY `FK_AccessKeyPair_Contact_ContactID`;

ALTER TABLE `BusinessApplicationSecret` DROP FOREIGN KEY `FK_BusinessApplicationSecret_AccessKeyPair_AccessKeyPairID`;

ALTER TABLE `BusinessApplicationSecret` DROP FOREIGN KEY `FK_BusinessApplicationSecret_AccessKeyPair_JwtSigningAccessKeyP~`;

ALTER TABLE `LicenseFeature` DROP FOREIGN KEY `FK_LicenseFeature_AccessKeyPair_AccessKeyPairID`;

ALTER TABLE `LicenseFeature` DROP INDEX `IX_LicenseFeature_AccessKeyPairID`;

CALL POMELO_BEFORE_DROP_PRIMARY_KEY(NULL, 'AccessKeyPair');
ALTER TABLE `AccessKeyPair` DROP PRIMARY KEY;

ALTER TABLE `LicenseFeature` DROP COLUMN `AccessKeyPairID`;

ALTER TABLE `Entitlement` DROP COLUMN `PassPhrase`;

ALTER TABLE `AccessKeyPair` RENAME `SecurityCertificate`;

ALTER TABLE `Item` RENAME COLUMN `MaxLicenseUtilizations` TO `TrialSubscriptionRelativeExpirationInDays`;

ALTER TABLE `Entitlement` RENAME COLUMN `Class` TO `SubscriptionClass`;

ALTER TABLE `SecurityCertificate` RENAME COLUMN `IP` TO `ID`;

ALTER TABLE `SecurityCertificate` RENAME INDEX `IX_AccessKeyPair_ContactID` TO `IX_SecurityCertificate_ContactID`;

ALTER TABLE `SecurityCertificate` RENAME INDEX `IX_AccessKeyPair_BusinessProfileRecordID` TO `IX_SecurityCertificate_BusinessProfileRecordID`;

ALTER TABLE `SecurityCertificate` RENAME INDEX `IX_AccessKeyPair_BusinessID` TO `IX_SecurityCertificate_BusinessID`;

ALTER TABLE `SecurityCertificate` RENAME INDEX `IX_AccessKeyPair_AccountHolderID` TO `IX_SecurityCertificate_AccountHolderID`;

ALTER TABLE `LicenseFeature` ADD `Key` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `LicenseFeature` ADD `Value` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Item` ADD `AllowSubscriptionTrials` tinyint(1) NULL;

ALTER TABLE `Item` ADD `IsPerpetualSubscription` tinyint(1) NULL;

ALTER TABLE `Item` ADD `LicensingCertificateID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Item` ADD `MaxLicenseUsages` int NULL;

ALTER TABLE `Item` ADD `StandardSubscriptionRelativeExpirationInDays` int NULL;

ALTER TABLE `Item` ADD `SubscriptionsCertificateID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Entitlement` ADD `LicenseClass` int NULL;

ALTER TABLE `Entitlement` ADD `SecurityCertificateID` varchar(255) CHARACTER SET utf8mb4 NULL;

ALTER TABLE `SecurityCertificate` ADD `ExpirePeriod` int NOT NULL DEFAULT 0;

ALTER TABLE `SecurityCertificate` ADD `Expired` tinyint(1) NOT NULL DEFAULT FALSE;

ALTER TABLE `SecurityCertificate` ADD `PassPhrase` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `SecurityCertificate` ADD `Type` longtext CHARACTER SET utf8mb4 NOT NULL;

ALTER TABLE `SecurityCertificate` ADD CONSTRAINT `PK_SecurityCertificate` PRIMARY KEY (`ID`);
CALL POMELO_AFTER_ADD_PRIMARY_KEY(NULL, 'SecurityCertificate', 'ID');
...
CREATE TABLE `SubscriptionFeature` (
    ...
    CONSTRAINT `FK_SubscriptionFeature_BusinessProfileRecord_BusinessProfileRec~` FOREIGN KEY (`BusinessProfileRecordID`) REFERENCES `BusinessProfileRecord` (`ID`),
...
ALTER TABLE `BusinessApplicationSecret` ADD CONSTRAINT `FK_BusinessApplicationSecret_SecurityCertificate_JwtSigningAcce~` FOREIGN KEY (`JwtSigningAccessKeyPairID`) REFERENCES `SecurityCertificate` (`ID`);
...
ALTER TABLE `SecurityCertificate` ADD CONSTRAINT `FK_SecurityCertificate_BusinessProfileRecord_BusinessProfileRec~` FOREIGN KEY (`BusinessProfileRecordID`) REFERENCES `BusinessProfileRecord` (`ID`);
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220726081900_V_1_9_8', '7.0.9');
...
ALTER TABLE `SecurityCertificate` ADD `EncryptedPrivateKey` tinyint(1) NOT NULL DEFAULT FALSE;

ALTER TABLE `SecurityCertificate` ADD `PrivateRsaParameters` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `SecurityCertificate` ADD `PublicRsaParameters` longtext CHARACTER SET utf8mb4 NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220726114938_V_1_9_9', '7.0.9');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220805073632_V_1_9_9_4', '7.0.9');

COMMIT;

START TRANSACTION;

ALTER TABLE `CountryLanguage` ADD `Enabled` tinyint(1) NOT NULL DEFAULT FALSE;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20221025200404_V_1_9_9_28', '7.0.9');

COMMIT;

START TRANSACTION;

ALTER TABLE `Commission` DROP FOREIGN KEY `FK_Commission_Contact_EmmisorContactID`;

ALTER TABLE `Commission` DROP FOREIGN KEY `FK_Commission_WalletAccount_EmmisorWalletAccountID`;

ALTER TABLE `Invoice` DROP FOREIGN KEY `FK_Invoice_ContactProfile_EmmisorBillingProfileID`;

ALTER TABLE `Invoice` DROP FOREIGN KEY `FK_Invoice_WalletAccount_EmmisorWalletAccountID`;

ALTER TABLE `Payment` DROP FOREIGN KEY `FK_Payment_WalletAccount_EmmisorWalletAccountID`;

ALTER TABLE `PaymentDispute` DROP FOREIGN KEY `FK_PaymentDispute_WalletAccount_EmmisorWalletAccountID`;

ALTER TABLE `PaymentDispute` RENAME COLUMN `EmmisorWalletAccountID` TO `EmisorWalletAccountID`;

ALTER TABLE `PaymentDispute` RENAME INDEX `IX_PaymentDispute_EmmisorWalletAccountID` TO `IX_PaymentDispute_EmisorWalletAccountID`;

ALTER TABLE `Payment` RENAME COLUMN `EmmisorWalletAccountID` TO `EmisorWalletAccountID`;

ALTER TABLE `Payment` RENAME INDEX `IX_Payment_EmmisorWalletAccountID` TO `IX_Payment_EmisorWalletAccountID`;

ALTER TABLE `Invoice` RENAME COLUMN `EmmisorWalletAccountID` TO `EmisorWalletAccountID`;

ALTER TABLE `Invoice` RENAME COLUMN `EmmisorBillingProfileID` TO `EmisorBillingProfileID`;

ALTER TABLE `Invoice` RENAME INDEX `IX_Invoice_EmmisorWalletAccountID` TO `IX_Invoice_EmisorWalletAccountID`;

ALTER TABLE `Invoice` RENAME INDEX `IX_Invoice_EmmisorBillingProfileID` TO `IX_Invoice_EmisorBillingProfileID`;

ALTER TABLE `Commission` RENAME COLUMN `EmmisorWalletAccountID` TO `EmisorWalletAccountID`;

ALTER TABLE `Commission` RENAME COLUMN `EmmisorContactID` TO `EmisorContactID`;

ALTER TABLE `Commission` RENAME INDEX `IX_Commission_EmmisorWalletAccountID` TO `IX_Commission_EmisorWalletAccountID`;

ALTER TABLE `Commission` RENAME INDEX `IX_Commission_EmmisorContactID` TO `IX_Commission_EmisorContactID`;

ALTER TABLE `Commission` ADD CONSTRAINT `FK_Commission_Contact_EmisorContactID` FOREIGN KEY (`EmisorContactID`) REFERENCES `Contact` (`ID`);

ALTER TABLE `Commission` ADD CONSTRAINT `FK_Commission_WalletAccount_EmisorWalletAccountID` FOREIGN KEY (`EmisorWalletAccountID`) REFERENCES `WalletAccount` (`ID`);

ALTER TABLE `Invoice` ADD CONSTRAINT `FK_Invoice_ContactProfile_EmisorBillingProfileID` FOREIGN KEY (`EmisorBillingProfileID`) REFERENCES `ContactProfile` (`ID`);

ALTER TABLE `Invoice` ADD CONSTRAINT `FK_Invoice_WalletAccount_EmisorWalletAccountID` FOREIGN KEY (`EmisorWalletAccountID`) REFERENCES `WalletAccount` (`ID`);

ALTER TABLE `Payment` ADD CONSTRAINT `FK_Payment_WalletAccount_EmisorWalletAccountID` FOREIGN KEY (`EmisorWalletAccountID`) REFERENCES `WalletAccount` (`ID`);

ALTER TABLE `PaymentDispute` ADD CONSTRAINT `FK_PaymentDispute_WalletAccount_EmisorWalletAccountID` FOREIGN KEY (`EmisorWalletAccountID`) REFERENCES `WalletAccount` (`ID`);

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20230623232442_V_1_9_9_50', '7.0.9');

COMMIT;

START TRANSACTION;

ALTER TABLE `Location` RENAME COLUMN `Longitud` TO `Longitude`;

ALTER TABLE `Location` RENAME COLUMN `Latitud` TO `Latitude`;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20230806222948_V_1_9_9_57', '7.0.9');
