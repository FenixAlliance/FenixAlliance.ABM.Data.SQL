...
VALUES (N'20220524003345_V_1_5_6', N'7.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220525022115_V_1_5_8', N'7.0.9');
GO
...
UPDATE [CurriculumRecord] SET [Priority] = 0.0 WHERE [Priority] IS NULL;
...
UPDATE [CurriculumRecord] SET [Date] = '0001-01-01T00:00:00.0000000' WHERE [Date] IS NULL;
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220528230436_V_1_6_1', N'7.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220529193855_V_1_6_2', N'7.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220530004202_V_1_6_3', N'7.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220530030021_V_1_6_4', N'7.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220530042707_V_1_6_5', N'7.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220531072147_V_1_6_5_1', N'7.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220612013856_V_1_7_7_2', N'7.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220613055849_V_1_7_7_3', N'7.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220620194055_V_1_7_8', N'7.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220624140610_V_1_7_9', N'7.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220709201431_V_1_8_3', N'7.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220711115821_V_1_8_4', N'7.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220718072302_V_1_9_0', N'7.0.9');
GO
...
UPDATE [BusinessProfileInvitation] SET [Email] = N'' WHERE [Email] IS NULL;
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220719215226_V_1_9_1', N'7.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220725224315_V_1_9_7', N'7.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220726082519_V_1_9_8', N'7.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220726115151_V_1_9_9', N'7.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220805161642_V_1_9_9_4', N'7.0.9');
GO
...
ALTER TABLE [CountryLanguage] ADD [Enabled] bit NOT NULL DEFAULT CAST(0 AS bit);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20221025200727_V_1_9_9_28', N'7.0.9');
GO
...
ALTER TABLE [Commission] DROP CONSTRAINT [FK_Commission_Contact_EmmisorContactID];
GO

ALTER TABLE [Commission] DROP CONSTRAINT [FK_Commission_WalletAccount_EmmisorWalletAccountID];
GO

ALTER TABLE [Invoice] DROP CONSTRAINT [FK_Invoice_ContactProfile_EmmisorBillingProfileID];
GO

ALTER TABLE [Invoice] DROP CONSTRAINT [FK_Invoice_WalletAccount_EmmisorWalletAccountID];
GO

ALTER TABLE [Payment] DROP CONSTRAINT [FK_Payment_WalletAccount_EmmisorWalletAccountID];
GO

ALTER TABLE [PaymentDispute] DROP CONSTRAINT [FK_PaymentDispute_WalletAccount_EmmisorWalletAccountID];
GO

EXEC sp_rename N'[PaymentDispute].[EmmisorWalletAccountID]', N'EmisorWalletAccountID', N'COLUMN';
GO

EXEC sp_rename N'[PaymentDispute].[IX_PaymentDispute_EmmisorWalletAccountID]', N'IX_PaymentDispute_EmisorWalletAccountID', N'INDEX';
GO

EXEC sp_rename N'[Payment].[EmmisorWalletAccountID]', N'EmisorWalletAccountID', N'COLUMN';
GO

EXEC sp_rename N'[Payment].[IX_Payment_EmmisorWalletAccountID]', N'IX_Payment_EmisorWalletAccountID', N'INDEX';
GO

EXEC sp_rename N'[Invoice].[EmmisorWalletAccountID]', N'EmisorWalletAccountID', N'COLUMN';
GO

EXEC sp_rename N'[Invoice].[EmmisorBillingProfileID]', N'EmisorBillingProfileID', N'COLUMN';
GO

EXEC sp_rename N'[Invoice].[IX_Invoice_EmmisorWalletAccountID]', N'IX_Invoice_EmisorWalletAccountID', N'INDEX';
GO

EXEC sp_rename N'[Invoice].[IX_Invoice_EmmisorBillingProfileID]', N'IX_Invoice_EmisorBillingProfileID', N'INDEX';
GO

EXEC sp_rename N'[Commission].[EmmisorWalletAccountID]', N'EmisorWalletAccountID', N'COLUMN';
GO

EXEC sp_rename N'[Commission].[EmmisorContactID]', N'EmisorContactID', N'COLUMN';
GO

EXEC sp_rename N'[Commission].[IX_Commission_EmmisorWalletAccountID]', N'IX_Commission_EmisorWalletAccountID', N'INDEX';
GO

EXEC sp_rename N'[Commission].[IX_Commission_EmmisorContactID]', N'IX_Commission_EmisorContactID', N'INDEX';
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20230623232748_V_1_9_9_50', N'7.0.9');
GO
...
EXEC sp_rename N'[Location].[Longitud]', N'Longitude', N'COLUMN';
GO

EXEC sp_rename N'[Location].[Latitud]', N'Latitude', N'COLUMN';
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20230806223218_V_1_9_9_57', N'7.0.9');
GO
